            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-evenly' }}>
                <View>
                    ...
                    <ProgressCircle color={colors.warn} progress={macros ? (carbs / macros.carbs) : 0} >
                        <Text style={styles.macroText}>{carbs}<Text style={{ position: "relative" }}>g</Text></Text>
                    </ProgressCircle>
                </View>
                <View>
                    <Text style={styles.macroLabel}>Protein</Text>
                    <ProgressCircle color={colors.textPrimary} progress={macros ? (protein / macros.protein) : 0}>
                        <Text style={styles.macroText}>{protein}<Text style={{ position: "relative" }}>g</Text></Text>
                    </ProgressCircle>
                </View>
                <View>
                    <Text style={styles.macroLabel}>Fat</Text>
                    <ProgressCircle color={colors.orange} progress={macros ? (fat / macros.fat) : 0} >
                        <Text style={styles.macroText}>{fat}<Text style={{ position: "relative" }}>g</Text></Text>
                    </ProgressCircle>
                </View>
            </View>
